...
O administrador deve publicar os templates no seguinte nó principal do Firebase:

- `/dados/indices/instrucoes_admin_templates/instrucoes_admin_templates.json`
- *(Alternativos aceitos automaticamente pelo aplicativo: `/dados/instrucoes_admin_templates.json` ou `/instrucoes_admin_templates.json`)*
...
## 4. Formatação do Título (`titulo`) e Descrição (`descricao`)
...
## 5. Regra de Publicação e Substituição Automática
...
## 6. Exemplos de JSON Schema (Formatos Suportados)
